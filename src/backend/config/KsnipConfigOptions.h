...
public:
    ...
    static QString ushareUsernameString();
    static QString ushareClientIdString();
    static QString ushareClientSecretString();
    static QString ushareAccessTokenString();
    static QString ushareRefreshTokenString();
    static QString ushareForceAnonymousString();
    static QString ushareLinkDirectlyToImageString();
    static QString ushareOpenLinkInBrowserString();
    static QString ushareAlwaysCopyToClipboardString();
    static QString ushareBaseUrlString();
...
private:
    ...
    static QString ushareSectionString();
