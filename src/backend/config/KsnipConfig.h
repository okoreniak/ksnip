...
public:
    ...
    virtual QString ushareUsername() const;
    virtual void setUshareUsername(const QString &username);

    virtual QByteArray ushareClientId() const;
    virtual void setUshareClientId(const QString &clientId);

    virtual QByteArray ushareClientSecret() const;
    virtual void setUshareClientSecret(const QString &clientSecret);

    virtual QByteArray ushareAccessToken() const;
    virtual void setUshareAccessToken(const QString &accessToken);

    virtual QByteArray ushareRefreshToken() const;
    virtual void setUshareRefreshToken(const QString &refreshToken);

    virtual bool ushareForceAnonymous() const;
    virtual void setUshareForceAnonymous(bool enabled);

    virtual bool ushareLinkDirectlyToImage() const;
    virtual void setUshareLinkDirectlyToImage(bool enabled);

    virtual bool ushareAlwaysCopyToClipboard() const;
    virtual void setUshareAlwaysCopyToClipboard(bool enabled);

    virtual bool ushareOpenLinkInBrowser() const;
    virtual void setUshareOpenLinkInBrowser(bool enabled);

    virtual QString ushareBaseUrl() const;
    virtual void setUshareBaseUrl(const QString &baseUrl);
