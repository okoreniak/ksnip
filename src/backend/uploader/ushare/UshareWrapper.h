...
#ifndef KSNIP_UshareWRAPPER_H
#define KSNIP_UshareWRAPPER_H
...
class UshareWrapper : public QObject
{
    Q_OBJECT
public:
    explicit UshareWrapper(const QString &UshareUrl, QObject *parent);
...
signals:
    void uploadFinished(const UshareResponse &response) const;
