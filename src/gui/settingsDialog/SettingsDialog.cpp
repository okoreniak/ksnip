...
SettingsDialog::SettingsDialog(QWidget *parent, const QList<CaptureModes> &captureModes) :
    ...
    mUshareUploaderSettings(new UshareUploaderSettings(mConfig)),
...
SettingsDialog::~SettingsDialog()
{
    ...
    delete mScriptUploaderSettings;
    delete mUshareUploaderSettings;
...
void SettingsDialog::saveSettings()
{
    ...
    mUshareUploaderSettings->saveSettings();
...
void SettingsDialog::initGui()
{
    ...
    mStackedLayout->addWidget(mUshareUploaderSettings);
    ...
    auto ushareUpLoader = new QTreeWidgetItem(uploader, { tr("Ushare Uploader") });
    ...
    mNavigatorItems.append(ushareUpLoader);
